...
live2d_settings['tipsMessage']          = 'https://blog.lucas04.xyz/assets/live2d/waifu-tips.js';            // 同目录下可省略路径
...
live2d_settings['waifuToolTop']         = '2px'         // 工具栏顶部边距，例如 '0px', '-60px'
live2d_settings['waifuMinWidth']        = '640px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
...
live2d_settings['homePageUrl']          = 'https://blog.lucas04.xyz/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://blog.lucas04.xyz/about';
